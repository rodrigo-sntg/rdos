#ifndef __RDOS__DRIVERS__AMD_AM79C973_H
#define __RDOS__DRIVERS__AMD_AM79C973_H
...
namespace rdos
{
    namespace drivers
    {
        ...
        public:
            amd_am79c973(rdos::hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor *dev, rdos::hardwarecommunication::InterruptManager* interrupts);
            ~amd_am79c973();
